...
import com.example.jniactivity.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity {
    // Used to load the 'androidnativeeinfochip' library on application startup.  static {
    static {
        System.loadLibrary("jniactivity");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnJNIStringArray.setOnClickListener(new View.OnClickListener() {  @Override
        public void onClick(View v) {
    ...
    public native String sendYourName(String firstName, String lastName);  public native String[] stringArrayFromJNI();
}
