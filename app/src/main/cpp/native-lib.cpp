...
Java_com_example_jniactivity_MainActivity_stringFromJNI(  JNIEnv* env,
                                                                      jobject /* this */) {
...
Java_com_example_jniactivity_MainActivity_sendYourName(JNIEnv *env, jobject  thiz, jstring first_name,jstring last_name) {
...
Java_com_example_jniactivity_MainActivity_stringArrayFromJNI(JNIEnv *env,  jobject thiz) {  char *days[]={"Java","Android","Django","SQL","Swift","Kotlin","Springs"};
    jstring str;
    jobjectArray day = 0;
    jsize len = 7;
    int i;
